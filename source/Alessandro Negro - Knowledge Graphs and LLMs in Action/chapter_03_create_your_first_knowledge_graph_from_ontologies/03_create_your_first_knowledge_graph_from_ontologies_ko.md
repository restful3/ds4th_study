...
![지식 그래프 구축 과정을 CRISP-DM 단계와 연결한 한국어 멘탈 모델](images/ko/figure-3-1-ko.png)
그림 3.1 비즈니스 목표 이해에서 임상의의 활동을 지원하는 지식 그래프 질의 정의에 이르기까지, CRISP-DM 모델의 구체화로서 지식 그래프 구축 과정에 대한 정신 모델

![KG에 맞게 조정한 CRISP-DM 모델](images/ko/figure-3-2-ko.png)
...
![임상의 활동을 지원하는 KG를 만들기 위한 비즈니스 이해 단계](images/ko/figure-3-3-ko.png)
...
![제1형 당뇨병을 질병과 표현형 특징으로 구분한 도식](images/ko/figure-3-4-ko.png)
...
![임상의 활동을 지원하기 위한 데이터 이해 단계](images/ko/figure-3-5-ko.png)
...
![HPO 주석의 한 행을 질병과 표현형 특징 사이의 간선으로 변환하는 과정](images/ko/figure-3-6-ko.png)
...
![그래프 데이터베이스에 적재된 HPO 온톨로지의 일부](images/ko/figure-3-8-ko.png)
...
![주석 데이터셋을 수집하고 처리하는 단계](images/ko/figure-3-9-ko.png)
...
![완성된 KG에 질의하는 단계](images/ko/figure-3-10-ko.png)
...
![제1형 당뇨병과 관련된 표현형 특징 질의 결과](images/ko/figure-3-11-ko.png)
