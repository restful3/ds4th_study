...
![scispaCy가 문맥 단어를 활용해 지카 관련 개체를 올바르게 명확화한 결과](images/ko/listing-8-1-ko.png)
...
![SNOMED 계층 구조의 한 예. 더 깊은 레벨의 노드는 온톨로지의 원형 개체인 1레벨 노드의 정보를 이용해 분류될 수 있습니다.](images/ko/figure-8-1-ko.png)
...
![LLM과 SNOMED 같은 도메인 전용 온톨로지를 사용해 생물의학 텍스트를 처리하는 NED 시스템의 작업 흐름](images/ko/figure-8-2-ko.png)
...
![NED의 첫 단계인 NER. 우리 시나리오에서 개체명은 온톨로지에서 직접 유도되며, SNOMED에서는 1레벨 노드가 범주를 정의합니다.](images/ko/figure-8-3-ko.png)
...
![NED의 두 번째 단계인 후보 선택. 앞 단계에서 찾은 각 개체 언급에 대해, 이를 가리킬 수 있는 잠재 후보들을 조회합니다.](images/ko/figure-8-4-ko.png)
...
![NED의 세 번째 단계인 후보 명확화. 그래프 기반 알고리즘(최단 경로 탐지)과 LLM을 결합해 최적 매칭을 고릅니다.](images/ko/figure-8-5-ko.png)
...
![NED 후보 명확화의 세 단계: (1) 문장 속 언급들에 연관된 모든 후보 사이의 최단 경로 탐지, (2) 탐지된 경로를 자연어 문장으로 변환, (3) 그 문장들을 명확화에 유용한 텍스트로 요약](images/ko/figure-8-6-ko.png)
