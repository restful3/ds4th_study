...
![노드를 특징 벡터로 변환하는 과정 — 각 특징은 지표와 알고리즘을 통해 특정 성질을 포착한다](images/ko/figure-10-2-ko.png)
...
![세 노드가 서로 모두 연결되면 삼각형을 이룬다](images/ko/figure-10-3-ko.png)
...
![밀도 계산 코드 리스트 이미지 1](images/ko/listing-10-5a-ko.png)

![밀도 계산 코드 리스트 이미지 2](images/ko/listing-10-5b-ko.png)
...
![관계 예측 과정을 노드 분류 과정과 비교한 그림](images/ko/figure-10-4-ko.png)
...
![4장에서 소개된 Hetionet 스키마](images/ko/figure-10-5-ko.png)

> **그림 10.5** 4장에서 제시된 Hetionet 스키마입니다.

![Hetionet의 메타그래프와 메타경로 예시](images/ko/figure-10-6-ko.png)
...
![각 값은 특정 화합물과 질병을 출발·도착으로 하는 경로 인스턴스에 대해 계산된 메타경로 값이다](images/ko/figure-10-7-ko.png)
...
![ReFeX는 각 노드를 여러 스케일의 위상 특징을 나타내는 벡터로 변환한다](images/ko/figure-10-8-ko.png)
...
![ReFeX 반복 과정 일부 도해 (1)](images/ko/figure-10-10a-ko.png)
