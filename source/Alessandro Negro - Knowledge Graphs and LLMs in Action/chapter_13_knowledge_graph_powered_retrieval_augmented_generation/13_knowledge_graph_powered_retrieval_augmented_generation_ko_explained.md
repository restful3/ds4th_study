...
![그림 13.1 KG 기반 질의응답을 위한 AI 에이전트 설계. 에이전트는 여러 도구를 갖추고 있으며, 이 도구들은 벡터 데이터베이스와 KG 같은 외부 데이터 소스를 활용해 사용자 질문에 필요한 맥락을 제공합니다.](images/a0ec23012b69ee2915e3105c480e68c75d951f578bdb783ae58724842b6865d7.jpg)
...
![그림 13.2 벡터 검색 기반 검색 증강 생성. 문서는 조밀한(dense) 벡터 표현으로 임베딩되어 벡터 데이터베이스에 색인됩니다. 사용자가 질문을 하면 그 질문 역시 임베딩되고, 데이터베이스에서 가장 유사한 문서들이 검색됩니다. 그런 다음 에이전트가 최종 답을 생성합니다.](images/2abdf4a1445b2a54dbced1c521faa5c3e3e2940a9db925c1916f17c8f5b33073.jpg)
...
![그림 13.3 록펠러 아카이브 센터 KG는 텍스트 속성 그래프와 텍스트 짝지음 그래프를 결합합니다. 문서는 노드로 표현되며, 각 노드는 저자·문서 유형·날짜 같은 메타데이터를 나타내는 속성을 가집니다. 추출된 개체와 관계는 원본 문서까지 거슬러 추적할 수 있어서, AI 에이전트를 위한 KG 기반 문서 선택 도구를 설계할 수 있게 해 줍니다.](images/2a63f406f37df0791cfdd026c5f7830b7eb7264f3b9bd84e03dcb58e2ac446a0.jpg)
...
![그림 13.4 외부 데이터 소스(KG와 벡터 데이터베이스)에 근거를 둔 KG 기반 RAG 에이전트](images/b6f02fd6c2b8808beeccbf260d8eda110be13b80235629be5aa9fa801cbc6e7e.jpg)
...
![그림 13.5 우리 그래프 RAG 에이전트의 내부 단계 예시. 에이전트는 하나의 생각(thought)에서 시작해, KG 검색기를 사용해 도로시 M. 링크에 대해 이야기한 사람들의 목록을 얻습니다. 그런 다음 각 사람에 대해 KG 강화 문서 검색기를 사용해 관련 문서를 식별합니다. 마지막으로, 에이전트는 이 모든 것을 맥락으로 삼아 최종 답을 생성합니다.](images/3efd9b5d9906cfb5a8eec571f0eb93e23b27cbec45d0a2d3b57531e3ff6163c0.jpg)
